//+------------------------------------------------------------------+
//|                                  Triggerlines Shift Modified.mq4 |
...
extern int RperiodShift=0;
extern int LSMA_Period=20;
extern int LSMA_PeriodShift=0;
//----
int Draw4HowLong;
int shift;
int i;
...
//---- drawing settings
   ...
   SetIndexShift(0,LSMA_PeriodShift);
   SetIndexBuffer(1,ExtMapBuffer2);
   SetIndexStyle(1,DRAW_LINE,STYLE_SOLID,1);
   SetIndexShift(1,LSMA_PeriodShift);
   SetIndexBuffer(2,ExtMapBuffer3);
   SetIndexStyle(2,DRAW_LINE,STYLE_SOLID,1);
   SetIndexShift(2,RperiodShift);
   SetIndexBuffer(3,ExtMapBuffer4);
   SetIndexStyle(3,DRAW_LINE,STYLE_SOLID,1);
   SetIndexShift(3,RperiodShift);
