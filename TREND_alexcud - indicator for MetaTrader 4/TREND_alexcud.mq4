...
ObjectSetText("rez", "Results",9, "Verdana", Lime );
...
ObjectSet("rez", OBJPROP_YDISTANCE, 0);
  ...
  {txt = "Lucky BUY";
      ...
      if(m1==0){if(Symbol()=="EURUSD"){PlaySound("trendBayEURUSD.wav");GlobalVariableSet("Signal_EURUSD",600);}}
      if(m2==0){if(Symbol()=="USDCHF"){PlaySound("trendBayUSDCHF.wav");GlobalVariableSet("Signal_USDCHF",600);}}
      if(m3==0){if(Symbol()=="USDJPY"){PlaySound("trendBayUSDJPY.wav");GlobalVariableSet("Signal_USDJPY",600);}}
      if(m==0) {if(Symbol()=="GBPUSD"){PlaySound("trendBayGBPUSD.wav");GlobalVariableSet("Signal_GBPUSD",600);}}
      if(m4==0){if(Symbol()=="EURJPY"){PlaySound("trendBayEURJPY.wav");GlobalVariableSet("Signal_EURJPY",600);}}
      if(m5==0){if(Symbol()=="GBPJPY"){PlaySound("trendBayGBPJPY.wav");GlobalVariableSet("Signal_GBPJPY",600);}}
      if(m6==0){if(Symbol()=="AUDUSD"){PlaySound("trendBayAUDUSD.wav");GlobalVariableSet("Signal_AUDUSD",600);}}
 }
  
  if (ditog1 >= 75 && ditog2 >= 75 && ditog3 >= 75)
  {txt = "Lucky SELL";

      if(m1==0){if(Symbol()=="EURUSD"){PlaySound("trendSellEURUSD.wav");GlobalVariableSet("Signal_EURUSD",-600);}}
      if(m2==0){if(Symbol()=="USDCHF"){PlaySound("trendSellUSDCHF.wav");GlobalVariableSet("Signal_USDCHF",-600);}}
      if(m3==0){if(Symbol()=="USDJPY"){PlaySound("trendSellUSDJPY.wav");GlobalVariableSet("Signal_USDJPY",-600);}}
      if(m==0) {if(Symbol()=="GBPUSD"){PlaySound("trendSellGBPUSD.wav");GlobalVariableSet("Signal_GBPUSD",-600);}}
      if(m4==0){if(Symbol()=="EURJPY"){PlaySound("trendSellEURJPY.wav");GlobalVariableSet("Signal_EURJPY",-600);}}
      if(m5==0){if(Symbol()=="GBPJPY"){PlaySound("trendSellGBPJPY.wav");GlobalVariableSet("Signal_GBPJPY",-600);}}
      if(m6==0){if(Symbol()=="AUDUSD"){PlaySound("trendSellAUDUSD.wav");GlobalVariableSet("Signal_AUDUSD",-600);}}
  }
  
  ObjectCreate("txt", OBJ_LABEL, WindowFind(short_name), 0, 0);
  ObjectSetText("txt", txt,14, "Verdana", Lime );
  ObjectSet("txt", OBJPROP_XDISTANCE, 500);  
  ObjectSet("txt", OBJPROP_YDISTANCE, 35);
  
  ObjectCreate("txt2", OBJ_LABEL, WindowFind(short_name), 0, 0);
  ObjectSetText("txt2","Multi-timeframe Indicator \"TREND_ALEXCUD\"",9, "Verdana", Silver );
