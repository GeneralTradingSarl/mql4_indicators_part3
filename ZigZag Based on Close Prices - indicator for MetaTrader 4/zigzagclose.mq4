//+------------------------------------------------------------------+
//|                                                  ZigZagClose.mq4 |
//|                                    Copyright 2019, mindful FX UG |
//|                                         https://www.mindfulfx.de |
//+------------------------------------------------------------------+
#property copyright "2006-2014, MetaQuotes Software Corp. (ZigZag) / 2019, mindful FX UG (ZigZagClose)"
#property link      "https://www.mindfulfx.de"
#property strict
   ...
   for(i=limit; i>=0; i--)
     {
      ...
      if(extremum==lastlow)
        ...
        { 
         //--- new last low
         lastlow=extremum; 
         //--- discard extremum if current close is too high
      ...
      if(extremum==lasthigh)
      ...
      else 
        {
         //--- new last high
         lasthigh=extremum;
         //--- discard extremum if current close is too low
